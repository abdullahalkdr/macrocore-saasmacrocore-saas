...
export default function SupportTicketsPage() {
  ...
  // Approve goes through a small optional-comment modal; Reject confirms through
  // ConfirmDialog.tsx — the app's own styled confirmation, not the browser's native
  // confirm() — matching ApprovalsInboxPage.tsx / ApprovalWorkflowModal.tsx's own fix.
  ...
  function handleTicketApprovalReject() {
    setConfirmingTicketReject(true);
  }

  function confirmTicketReject() {
    setConfirmingTicketReject(false);
