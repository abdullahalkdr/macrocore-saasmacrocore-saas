...
export const content: Record<Lang, Content> = {
  ar: {
    ...
    billingMonthly: 'شهري',
    billingAnnual: 'سنوي (وفّر حتى ١٩٪)',
    billingSave: 'وفّر حتى ١٩٪ مع الاشتراك السنوي',
    annualCallout: 'وفّر حتى ١٩٪ مع الاشتراك السنوي.',
  ...
  en: {
    ...
    billingAnnual: 'Annual (save up to 19%)',
    billingSave: 'Save up to 19% with annual billing',
    annualCallout: 'Save up to 19% with annual billing.',
