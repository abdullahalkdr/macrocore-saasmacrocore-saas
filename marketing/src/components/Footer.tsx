...
export default function Footer() {
  ...
  const resourceLinks: { label: string; to?: string; action?: () => void }[] = [
    { label: t.footer.resourceLinks[0], to: '/help' },
    { label: t.footer.resourceLinks[1], action: () => goToSection('how') },
    { label: t.footer.resourceLinks[2], to: '/faq' },
  ];

  const companyLinks = [
    { label: t.footer.companyLinks[0], to: '/about' },
    { label: t.footer.companyLinks[1], to: '/contact' },
    { label: t.footer.companyLinks[2], to: '/terms' },
    { label: t.footer.companyLinks[3], to: '/privacy' },
  ];
  ...
  return (
    <footer className="mk-footer">
      <div className="mk-container mk-footer-inner">
        <div>
          <Link to="/" className="mk-logo mk-logo-footer mk-logo-link">
            macrocore
          </Link>
